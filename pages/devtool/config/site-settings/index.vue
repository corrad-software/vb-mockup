...
const getCurrentLogo = () => {
  return settings.value.siteLogo || siteSettings.value.siteLogo || '/img/logo/NAS-logo.svg';
};

const getCurrentLoadingLogo = () => {
  return settings.value.siteLoadingLogo || siteSettings.value.siteLoadingLogo || '/img/logo/NAS-logo.svg';
};
...
const getCurrentLoginLogo = () => {
  return settings.value.siteLoginLogo || siteSettings.value.siteLoginLogo || '/img/logo/NAS-logo.svg';
};
